...
export const Experience: ExperienceType[] = [
  {
    ...
    content: {
      ...
      list: [
        ...
        'Implemented responsive design systems to ensure consistent user experience across desktop, tablet, and mobile views.',
        'Redesigned pages based on provided mockups, ensuring visual accuracy and improved user experience through close coordination with the lead designer.',
      ],
      tech: [
        '.NET C#',
        'Razor',
  ...
  },
  {
    ...
    subtitle: 'Talent Gateway - Sydney, Australia',
    website: 'https://www.talentgateway.com.au/',
    date: 'January 2025 - Present',
    content: {
      text: '',
      list: [
        'Developed and maintained mobile applications using Flutter, Dart, React Native and TypeScript, delivering seamless user experiences across platforms.',
        'Collaborated with cross-functional teams to implement new features and improve existing functionality, ensuring high-quality code and user satisfaction.',
        'Optimized app performance and user interface, resulting in improved user engagement and retention.',
        'Handled Google Play and Apple App Store deployments including versioning, release builds, and compliance.',
      ],
      tech: [
        'Flutter',
        'Dart',
